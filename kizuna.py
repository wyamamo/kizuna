...
def print_battle_record(n, event_a, mcard, wld_0f, wld_0z, wld_1f, wld_1z, game0, stage0, ms0, win0, base0, game1, stage1, ms1, win1, base1, gauge, gtotal):
	a = army(ms0)
	...
	for line in fileinput.input(files=args.files,openhook=fileinput.hook_compressed):
		...
		if((event_a and len(l) == 12) or ((not event_a) and len(l) >= 10)):
			...
			if(debug_a):
				...
				print_battle_record(n, event_a, mcard, wld_0f, wld_0z, wld_1f, wld_1z, game0, stage0, ms0, win0, base0, game1, stage1, ms1, win1, base1, gauge, gtotal)
		else:
